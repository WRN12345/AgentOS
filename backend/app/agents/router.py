...
async def _get_run_in_project(
    ...
    跨项目和不存在均返回 None，由调用方统一响应 404，避免泄漏其他项目资源是否存在。
    """
